    ...
    <div class="row">
      ...
      <div class="col-10 bg-transparent">
        <div class="container-fluid">
          ...
          <form method="POST" action="insert_semester.php" name="datavalid" onsubmit="return validateForm()">
            <div class="form-group row">
              <label for="SemesterID" class="col-sm-2 col-form-label">ID</label>
              <div class="col-4">
                <input type="text" class="form-control form-control-sm" name="SemesterID" value="Auto Genarated" readonly>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-4">
                <input type="text" class="form-control form-control-sm" name="SemesterTitle" value="" required>
              </div>
            </div>
            <div class="form-group row">
          ...
          <script>
            function validateForm() {
              var SemesterTitile = document.forms["datavalid"]["SemesterTitile"].value;
