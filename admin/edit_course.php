    ...
    <div class="row">
      ...
      <div class="col-10 bg-transparent">
        <div class="container-fluid">
          ...
          <form method="POST" action="update_course.php" name="datavalid" onsubmit="return validateForm()">
            <div class="form-group row">
              <label for="CourseID" class="col-sm-2 col-form-label">ID</label>
              <div class="col-4">
                <input type="text" class="form-control form-control-sm" name="CourseID" value='<?php echo $_GET['CourseID'] ?>' readonly required>
              </div>
            </div>
            <div class="form-group row">
              <label for="CourseCode" class="col-sm-2 col-form-label">Course Code</label>
              <div class="col-4">
                <input type="text" class="form-control form-control-sm" name="CourseCode" value='<?php echo $_GET['CourseCode'] ?>' required>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-4">
                <input type="text" class="form-control form-control-sm" name="CourseName" value='<?php echo $_GET['CourseName'] ?>' required>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-4">
                <select class="form-control" id="DepartmentID" name="DepartmentID">
                  ...
                  $_GETs = $indObj->getAllDepartmentsInfo();
                  while ($d = mysqli_fetch_assoc($_GETs)) {
                    if ($_GET["DepartmentID"] == $d["DepartmentID"]) {
