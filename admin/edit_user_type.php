    ...
    <div class="row">
      ...
      <div class="col-10 bg-transparent">
        <div class="container-fluid">
          <form method="POST" action="update_user_type.php" name="datavalid" onsubmit="return validateForm()">
            <div class="form-group row">
              <label for="UserTypeID" class="col-sm-2 col-form-label">ID</label>
              <div class="col-4">
                <input type="text" class="form-control form-control-sm" name="UserTypeID" value='<?php echo $_GET['UserTypeID'] ?>' readonly required>
              </div>
            </div>
            <div class="form-group row">
              <label for="UserTypeTitle" class="col-sm-2 col-form-label">Title</label>
              <div class="col-4">
                <input type="text" class="form-control form-control-sm" name="UserTypeTitle" value='<?php echo $_GET['UserTypeTitle'] ?>' required>
              </div>
            </div>
