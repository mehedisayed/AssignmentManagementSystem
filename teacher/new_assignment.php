    ...
    <div class="row">
      ...
      <div class="col-10 bg-transparent">
        <div class="container-fluid">
          ...
          <form method="POST" action="insert_assignment.php" enctype="multipart/form-data">
            <div class="form-group row">
              <label for="AssignmentTitle" class="col-sm-2 col-form-label">Title</label>
              <div class="col-4">
                <input type="text" class="form-control form-control-sm" name="AssignmentTitle" value="" required>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-4">
                <input type="text" class="form-control form-control-sm" name="AssignmentDetails" value="" required>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-4">
                <input type="date" class="form-control form-control-sm" name="StartDate" value="" required>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-4">
                <input type="date" class="form-control form-control-sm" name="EndDate" value="" required>
              </div>
            </div>
